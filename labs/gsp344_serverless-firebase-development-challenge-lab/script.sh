...
gcloud beta run deploy netflix-dataset-service-270 --image gcr.io/$GOOGLE_CLOUD_PROJECT/rest-api:0.1 --allow-unauthenticated
...
gcloud beta run deploy netflix-dataset-service-270 --image gcr.io/$GOOGLE_CLOUD_PROJECT/rest-api:0.2 --allow-unauthenticated
...
gcloud beta run deploy frontend-staging-service-923 --image gcr.io/$GOOGLE_CLOUD_PROJECT/frontend-staging:0.1
# Choose 1 and us-central1

# 6. Cloud Build Frontend Production
gcloud builds submit --tag gcr.io/$GOOGLE_CLOUD_PROJECT/frontend-production:0.1
gcloud beta run deploy frontend-production-service-630 --image gcr.io/$GOOGLE_CLOUD_PROJECT/frontend-production:0.1
# Choose 1 and us-central1
